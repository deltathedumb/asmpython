/* <setjmp.h> -- refused, and here is why.
   ...
   The APIR has none of those. It has virtual registers, basic blocks and
...
#error <setjmp.h> is not supported: longjmp restores a machine frame, and the APIR has no way to name one. Return an error code, or use a flag and a goto within the function.
