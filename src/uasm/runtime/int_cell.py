...
#
# STAGE 3 OF docs/INERT-RUNTIME.md, and the first piece of uasm's object
# runtime that is not C. It is compiled by uasm's own Python frontend on
...
# changed. See `tests/uasm/integration/test_ported_int.py`.
#
