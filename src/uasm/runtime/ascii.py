...
#
# HOW TO CHECK ONE. `tests/uasm/integration/test_ported_int.py` is the
...
#
#     PYTHONPATH=src python -m uasm run some_program.py
#     PYTHONPATH=src python -m uasm build some_program.py -o out.exe
#
