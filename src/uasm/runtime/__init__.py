"""uasm's object runtime, written in the machine subset.

NOT AN IMPORTABLE PACKAGE in any useful sense. The modules beside this one are
read as SOURCE and compiled by uasm's own Python frontend into every
...
The package exists so that the source travels with an installed uasm.
"""
