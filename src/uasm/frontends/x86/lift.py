...
HOW THIS IS VERIFIED, because reading it is not enough. `tests/uasm/
...
`tests/uasm/unit/test_x86_lift.py`.
"""
...
def split_functions(statements: list[Statement],
    ...
    notion of a function -- but it is the one both GCC and uasm follow,
...
class Lifter:
    ...
    def instruction(self, ins: Instr) -> None:
        ...
        raise LiftError(f"instruction {m!r} is not lifted", span,
                        help="this frontend implements the subset uasm "
