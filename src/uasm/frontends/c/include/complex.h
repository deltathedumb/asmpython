/* <complex.h> -- refused, and here is why.
   ...
   the UIR's type system is thirteen machine storage classes with nothing
...
#error <complex.h> is not supported: the UIR has no complex type, and every operator on one would be a call. Use a struct of two doubles.
