"""The JVM backend: one class, one static method per IR function.
    ...
    uasm build prog.py --backend jvm --java-version 21
    uasm build prog.py --backend jvm --class-version 75
    java -jar prog.jar
...
class _FunctionEmitter:
    ...
    def _float_to_int(self, ins: Instruction, dst: T.Type, sk: str,
        ...
        interpreter is what `uasm run` prints and what every differential
