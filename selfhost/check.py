...
TARGETS = [
    ...
    "asmpython/stdlib/assembly/__init__.py",
    "asmpython/stdlib/__init__.py",
    "asmpython/stdlib/math.py",
    "asmpython/stdlib/os.py",
    ...
    "asmpython/_targets/target_linux.py",
    "asmpython/_targets/target_windows.py",
