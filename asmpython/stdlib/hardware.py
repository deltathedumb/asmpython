...
BINDINGS: dict = {
    ...
    "mmio_write8": Func(
        arg_types=("int", "int"), ret_type="int", c_name="_hw_mmio_write8"
    ),
    "mmio_read32": Func(arg_types=("int",), ret_type="int", c_name="_hw_mmio_read32"),
    "mmio_write32": Func(
        arg_types=("int", "int"), ret_type="int", c_name="_hw_mmio_write32"
    ),
    # ---- CPU utilities ------------------------------------------------------
    ...
    "vga_set_color": Func(
        arg_types=("int", "int"), ret_type="int", c_name="_hw_vga_set_color"
    ),
    "vga_set_cursor": Func(
        arg_types=("int", "int"), ret_type="int", c_name="_hw_vga_set_cursor"
    ),
    ...
    "console_write": Func(
        arg_types=("str",), ret_type="int", c_name="_hw_console_write"
    ),
    "console_set_color": Func(
        arg_types=("int", "int"), ret_type="int", c_name="_hw_console_set_color"
    ),
    "console_set_cursor": Func(
        arg_types=("int", "int"), ret_type="int", c_name="_hw_console_set_cursor"
    ),
