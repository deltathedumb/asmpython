...
Counter__bump:
    ...
    xor rcx, rcx
    call _runtime_dict_get_default
    jmp .Lret_Counter__bump_2
    xor rax, rax
.Lret_Counter__bump_2:
    mov rsp, rbp
    pop rbp
    ret
Squarer____init__:
...
Squarer__square:
    ...
    xor rcx, rcx
    call _runtime_dict_get_default
    jmp .Lret_Squarer__square_4
    xor rax, rax
.Lret_Squarer__square_4:
    mov rsp, rbp
    pop rbp
    ret
section .bss
...
section .rdata
str_0: db 118,97,108,117,101,0
str_1: db 118,97,108,117,101,0
str_2: db 118,97,108,117,101,0
str_3: db 118,97,108,117,101,0
str_4: db 108,97,115,116,0
str_5: db 108,97,115,116,0
str_6: db 108,97,115,116,0
