...
Rectangle__area:
    ...
    pop rax
    imul rax, rbx
    jmp .Lret_Rectangle__area_6
    xor rax, rax
.Lret_Rectangle__area_6:
    mov rsp, rbp
    pop rbp
    ret
section .bss
...
section .rdata
str_0: db 115,105,100,101,0
str_1: db 83,113,117,97,114,101,32,97,114,101,97,32,61,0
str_2: db 82,101,99,116,97,110,103,108,101,32,97,114,101,97,32,61,0
str_3: db 110,97,109,101,0
str_4: db 115,105,100,101,0
str_5: db 115,105,100,101,0
str_6: db 115,105,100,101,0
str_7: db 119,0
str_8: db 104,0
str_9: db 119,0
str_10: db 104,0
