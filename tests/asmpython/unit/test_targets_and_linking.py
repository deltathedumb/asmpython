...
actual executable and runs it. Everything above it can pass while `asmpython build`
...
class TestTargetRegistry:
    ...
    def test_a_third_party_target_registers_the_same_way(self):
        ...
        try:
            ...
            from asmpython.target import registry
    ...
    def test_a_machine_backend_defaults_to_the_host(self):
        """Not to a platform fixed when the backend was written. `asmpython build
...
class TestAbiComesFromTheTarget:
    ...
    def test_each_builtin_gets_its_declared_abi(self):
        from asmpython.backends.x86_64.emit import MICROSOFT_X64, SYSTEM_V, abi_for
    ...
    def test_a_windows_abi_under_an_unrelated_name(self):
        ...
        from asmpython.backends.x86_64.emit import MICROSOFT_X64, abi_for
