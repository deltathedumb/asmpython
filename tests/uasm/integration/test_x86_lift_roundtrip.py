...
from uasm.frontends.x86.lift import ABI_INT_ARGS, lift_module
from uasm.frontends.x86.parse import parse
from uasm.ir import types as T
from uasm.ir.interpreter import Interpreter
from uasm.ir.verifier import verify
...
class TestTheRoundTripPreservesMeaning:
    ...
    def test_lifted_assembly_prints_what_the_ir_printed(self, seed, tmp_path):
        ...
        entry = "uasm_main" if lifted.function("uasm_main") else "main"
