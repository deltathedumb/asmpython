...
JVM and lives in `tests/uasm/integration/test_jvm.py`; these run
...
from uasm.backend.base import OptionError
from uasm.backend import BackendUnsupported
from uasm.backends.jvm import version as V
from uasm.backends.jvm.classfile import ConstantPool, _modified_utf8
from uasm.backends.jvm.emit import JvmBackend, _class_name, _normalized
from uasm.diagnostics import DiagnosticSink, Severity
from uasm.ir import types as T, verify
...
class TestReadingAClassPath:
    ...
    def test_it_reads_a_class_this_compiler_wrote(self):
        from uasm.backends.jvm.classpath import read_class
    ...
    def test_a_method_descriptor_parses_into_its_parameters(self):
        from uasm.backends.jvm.classpath import parse_parameters
    ...
    def test_a_file_that_is_not_a_class_is_refused(self):
        from uasm.backends.jvm.classpath import ClassFileError, read_class
    ...
    def test_a_jar_of_unreadable_entries_does_not_fail_the_build(self, tmp_path):
        ...
        import zipfile
        from uasm.backends.jvm.classpath import ClassPath
...
class TestJavaSymbols:
    ...
    def interop(self):
        from uasm.backends.jvm.classpath import ClassPath
        from uasm.backends.jvm.interop import Interop
        path = ClassPath()
    ...
    def test_mangling_round_trips(self, text):
        from uasm.backends.jvm.interop import mangle, unmangle
        wire = mangle(text)
