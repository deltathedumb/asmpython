...
from uasm.frontends.x86.parse import parse, split_args, strip_comment
from uasm.frontends.x86.syntax import (
...
class TestSeparatorsAreWhitespace:
    """GCC uses a tab, uasm a space, and the assembler neither cares."""
