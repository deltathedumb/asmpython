...
actual executable and runs it. Everything above it can pass while `uasm build`
...
class TestTargetRegistry:
    ...
    def test_a_third_party_target_registers_the_same_way(self):
        ...
        try:
            ...
            from uasm.target import registry
    ...
    def test_a_machine_backend_defaults_to_the_host(self):
        """Not to a platform fixed when the backend was written. `uasm build
...
class TestAbiComesFromTheTarget:
    ...
    def test_each_builtin_gets_its_declared_abi(self):
        from uasm.backends.x86_64.emit import MICROSOFT_X64, SYSTEM_V, abi_for
    ...
    def test_a_windows_abi_under_an_unrelated_name(self):
        ...
        from uasm.backends.x86_64.emit import MICROSOFT_X64, abi_for
    ...
    def test_an_unknown_abi_is_refused_not_guessed(self):
        from uasm.backends.x86_64.emit import UnsupportedOperation, abi_for
...
class TestRuntime:
    def test_the_entry_symbol_is_shared_not_repeated(self):
        ...
        from uasm.objects.support import RUNTIME_C, write_runtime
    ...
    def test_written_runtime_calls_the_backend_entry_symbol(self, tmp_path):
        from uasm.backend.base import ENTRY_SYMBOL
        from uasm.objects.support import write_runtime
    ...
    def test_a_module_that_never_prints_needs_no_runtime(self, tmp_path):
        ...
        from uasm.objects.support import needs_runtime
