...
from uasm.ir import Builder, Function, Module, types as T, verify
from uasm.ir.interpreter import run
from uasm.ir.module import Block, Instruction
from uasm.ir.opcodes import Op
from uasm.passes import Pass, PassManager, available, get, register
from uasm.passes.manager import KNOWN_TAGS
...
class TestPassManager:
    ...
    def test_verify_each_names_the_offending_pass(self):
        ...
        from uasm.ir.verifier import VerifyError
