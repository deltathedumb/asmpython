...
from uasm.backends.x86_64.emit import (
...
class TestHiddenCalls:
    ...
    def test_float_remainder_counts_as_a_call(self):
        ...
        from uasm.backends.x86_64.emit import _clobbers_volatiles
        from uasm.ir.module import Instruction
        from uasm.ir.opcodes import Op
    ...
    def test_liveness_honours_the_predicate(self):
        ...
        from uasm.backend import Liveness
        from uasm.ir import Builder, Function, Module, verify
        from uasm.ir.module import Instruction
        from uasm.ir.opcodes import Op
...
class TestBackendLimitsAreDiagnostics:
    def test_an_unsupported_operation_is_reported_not_raised(self, tmp_path):
        ...
        from uasm.backends.x86_64.emit import UnsupportedOperation
