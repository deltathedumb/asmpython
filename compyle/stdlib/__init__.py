"""Compyle's standard-library bindings.

Each submodule here defines a `BINDINGS` dict:

    BINDINGS = {
        "name_in_compyle": Func(arg_types=(...), ret_type="...", c_name="..."),
...
class Func:
    """Foreign function: maps a compyle name to a C ABI symbol with typed args."""
