...
# Linux-only ABI corrections for shared runtime helpers, applied here rather
# than from `_compiler/__init__`. It has to be at the END of this module: the
# fixes patch methods onto the class above, so the class must already exist.
# Doing it here means every route to LinuxCodegen -- the registry, a direct
# import, a subclass in an extension -- gets the patched class.
from .._compiler import linux_runtime_fixes as _linux_runtime_fixes  # noqa: E402,F401
